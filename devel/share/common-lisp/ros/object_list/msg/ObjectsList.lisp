...
(cl:defclass <ObjectsList> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (ego_geometric
    :reader ego_geometric
    :initarg :ego_geometric
    :type (cl:vector object_list-msg:Geometric)
   :initform (cl:make-array 0 :element-type 'object_list-msg:Geometric :initial-element (cl:make-instance 'object_list-msg:Geometric))))
)
...
(cl:ensure-generic-function 'ego_geometric-val :lambda-list '(m))
(cl:defmethod ego_geometric-val ((m <ObjectsList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_list-msg:ego_geometric-val is deprecated.  Use object_list-msg:ego_geometric instead.")
  (ego_geometric m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ObjectsList>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'ego_geometric))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (roslisp-msg-protocol:serialize ele ostream))
   (cl:slot-value msg 'ego_geometric))
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ObjectsList>) istream)
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'ego_geometric) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'ego_geometric)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'object_list-msg:Geometric))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ObjectsList>)))
  ...
  "1f7cfa43090ec402bb19255e11cb1345")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ObjectsList)))
  "Returns md5sum for a message object of type 'ObjectsList"
  "1f7cfa43090ec402bb19255e11cb1345")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ObjectsList>)))
  ...
  (cl:format cl:nil "Header header~%ObjectList[] obj_list~%Geometric[] ego_geometric~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: object_list/ObjectList~%int32 obj_id~%Geometric geometric~%float64[36] covariance~%Dimension dimension~%float32 prop_existence~%float32 prop_mov ~%Classification classification~%Features features~%~%================================================================================~%MSG: object_list/Geometric~%float64 x~%float64 y~%float64 vx~%float64 vy~%float64 ax~%float64 ay~%float64 yaw~%float64 yawrate~%~%================================================================================~%MSG: object_list/Dimension~%float64 length~%float64 width~%float64 height~%~%================================================================================~%MSG: object_list/Classification~%float32 car~%float32 truck~%float32 motorcycle~%float32 bicycle~%float32 pedestrian~%float32 stacionary~%float32 other~%~%================================================================================~%MSG: object_list/Features~%bool FL~%bool FM~%bool FR~%bool MR~%bool RR~%bool RM~%bool RL~%bool ML~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ObjectsList)))
  "Returns full string definition for message of type 'ObjectsList"
  (cl:format cl:nil "Header header~%ObjectList[] obj_list~%Geometric[] ego_geometric~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: object_list/ObjectList~%int32 obj_id~%Geometric geometric~%float64[36] covariance~%Dimension dimension~%float32 prop_existence~%float32 prop_mov ~%Classification classification~%Features features~%~%================================================================================~%MSG: object_list/Geometric~%float64 x~%float64 y~%float64 vx~%float64 vy~%float64 ax~%float64 ay~%float64 yaw~%float64 yawrate~%~%================================================================================~%MSG: object_list/Dimension~%float64 length~%float64 width~%float64 height~%~%================================================================================~%MSG: object_list/Classification~%float32 car~%float32 truck~%float32 motorcycle~%float32 bicycle~%float32 pedestrian~%float32 stacionary~%float32 other~%~%================================================================================~%MSG: object_list/Features~%bool FL~%bool FM~%bool FR~%bool MR~%bool RR~%bool RM~%bool RL~%bool ML~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ObjectsList>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'ego_geometric) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ (roslisp-msg-protocol:serialization-length ele))))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ObjectsList>))
  ...
  (cl:list 'ObjectsList
    ...
    (cl:cons ':ego_geometric (ego_geometric msg))
))
