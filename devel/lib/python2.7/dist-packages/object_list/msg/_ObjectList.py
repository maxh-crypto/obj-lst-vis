...
class ObjectList(genpy.Message):
  _md5sum = "734e0a3fa2ba5ceee95429910366b99c"
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.dimension.length, _x.dimension.width, _x.prop_existence, _x.prop_mov, _x.classification.car, _x.classification.truck, _x.classification.motorcycle, _x.classification.bicycle, _x.classification.pedestrian, _x.classification.stacionary, _x.classification.other, _x.features.FL, _x.features.FM, _x.features.FR, _x.features.MR, _x.features.RR, _x.features.RM, _x.features.RL, _x.features.ML,) = _get_struct_2d9f8B().unpack(str[start:end])
      return self
...
def _get_struct_i8d():
    ...
    return _struct_i8d
_struct_2d9f8B = None
def _get_struct_2d9f8B():
    global _struct_2d9f8B
    if _struct_2d9f8B is None:
        _struct_2d9f8B = struct.Struct("<2d9f8B")
    return _struct_2d9f8B
