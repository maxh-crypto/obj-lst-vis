...
class ObjectsList(genpy.Message):
  _md5sum = "1f7cfa43090ec402bb19255e11cb1345"
...
bool ML
"""
  __slots__ = ['header','obj_list','ego_geometric']
  _slot_types = ['std_msgs/Header','object_list/ObjectList[]','object_list/Geometric[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.ego_geometric)
      buff.write(_struct_I.pack(length))
      for val1 in self.ego_geometric:
        _x = val1
        buff.write(_get_struct_8d().pack(_x.x, _x.y, _x.vx, _x.vy, _x.ax, _x.ay, _x.yaw, _x.yawrate))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.ego_geometric = []
      for i in range(0, length):
        val1 = object_list.msg.Geometric()
        _x = val1
        start = end
        end += 64
        (_x.x, _x.y, _x.vx, _x.vy, _x.ax, _x.ay, _x.yaw, _x.yawrate,) = _get_struct_8d().unpack(str[start:end])
        self.ego_geometric.append(val1)
      return self
