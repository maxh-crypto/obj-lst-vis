...
# velocitiy of ego-vehicle and pedestrian	
# 2 Geschwindigkeiten waehlbar: hierzug müssen die 3 jeweiligen Werte für 20 bzw 40 kmh ein/auskommentiert werden
#			diese sind der Funktion markiert
			#PI Regler 
			Kp = 0.30	#P-Anteil
			Tn = 1.9	#I-Anteil

#Multiplikatoren 20 und 40kmh - einer von beiden muss ausgewählt werden
			#vsoll = 40 * 1.15/3.6			#40kmh
			vsoll = 20 * 1.22/3.6			#20kmh
#Position des Targets -einer von beiden muss ausgewaelt werden
			#if player_pos.x < 210:         #40kmh
			if player_pos.x < 217:		    #20kmh	
...
#Loslaufen des target - eins von beiden muss gewählt werden
			#if player_pos.x > 170.56:     #40kmh
			if player_pos.x > 197:		   #20kmh
				world.walker1.apply_control(world.control)
#ende Geschwindigkeitkeitsregelung
