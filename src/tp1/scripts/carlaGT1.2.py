...
class Feature2:
	def __init__(self,world,a1,a2,a3):
		values = [a1.FRval,a1.FMval,a1.FLval,a1.MRval,a1.MLval,a1.RRval,a1.RMval,a1.RLval,
		...
		for v in values:
			...
			values[a] = v
			a = a + 1
		valindex = numpy.argsort(values)
		print(valindex)

		for v in valindex:
			self.corr_val(valindex[0],1,a1,a2,a3)
